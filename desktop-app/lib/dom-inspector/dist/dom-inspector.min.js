...
!(function(t, e) {
    ...
    function s(t, e) {
        for (
            ;
            void 0 !== t && null !== t && 'BODY' !== t.tagName.toUpperCase();
                    ...
                    },
                    {
                        ...
                        value: function(t) {
                            for (var e = 0; e < this.exclude.length; e += 1) {
                                ...
                                if (r.isEqualNode(t.target) || s(t.target, r))
                                    return;
                            }
                            if (
                            ...
                            n(this.overlay.parent, {
                                ...
                                n(this.overlay.borderRight, {
                                    ...
                                    height:
                                        p.height - o['border-top-width'] + 'px',
                                    top:
                                        o['margin-top'] +
                                        o['border-top-width'] +
                                        'px',
                                ...
                                (i('.id', this.overlay.tips).innerHTML = this
                                    .target.id
                                    ? '#' + this.target.id
                                    : ''),
                            ...
                            var g = 0;
                            o.top >= 32
                                ? (this.overlay.tips.classList.remove(
                                      'reverse'
                                  ),
                                  (g = o.top - 24 - 8))
